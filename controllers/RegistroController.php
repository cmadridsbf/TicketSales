...
class RegistroController {
    ...
    public static function crear(Router $router) {
        ...
        // || $registro->paquete_id === "2" || $registro->paquete_id === "1" )
    ...
    public static function gratis(Router $router) {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if($resultado) {
                $email = new Email($_SESSION['email'], $_SESSION['nombre'], urlencode($token));
                $email->enviarConfirmacionBoleto();
                header('Location: /boleto?id=' . urlencode($registro->token));
    ...
    public static function boleto(Router $router) {
        ...
        $router->render('registro/boleto', [
            'titulo' => 'Asistencia a TicketSales',
            'registro' => $registro
        ]);
    }
    ...
    public static function conferencias(Router $router) {
        ...
        $url = "https://ticketsales.store/public/RestAPI/GetEventosUsuario.php?usuarioId=" . $usuario_id;
        // Inicializa cURL
        $ch = curl_init($url);

        // Configura cURL para que devuelva la respuesta como un string
        ...
        // Verifica el resultado y toma una decisión
        if ($respuesta == '[true]') {
            // Haz algo si el resultado es [true]
